...
void PetGame::SpriteRenderer::DrawSprite(const Texture2D& texture, glm::vec2 position, glm::vec2 size, float rotate, glm::vec3 color)
{
	m_shader.use();
...
{
	this->DrawSprite(pet->getTexture(),pet->getPosition(),pet->getSize(),pet->getRotation(),pet->getColor());
}
